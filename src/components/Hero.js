    ...
    <div id="default-carousel" data-carousel="slide" className="relative"> 
        <div className="overflow-hidden relative h-56 rounded-lg sm:h-64 xl:h-80 2xl:h-96">
            ...
            <div className="hidden duration-700 ease-in-out" data-carousel-item="active">
                <img src="https://picsum.photos/id/127/4032/2272" className="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="hero__slider" />
            </div>

            <div className="hidden duration-700 ease-in-out" data-carousel-item="">
                <img src="https://picsum.photos/id/154/3264/2176" className="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="hero__slider"/>
            </div>

            <div className="hidden duration-700 ease-in-out" data-carousel-item="">
                <img src="https://picsum.photos/id/174/1600/589" className="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="hero__slider" />
            </div>
        </div>
